// code credits to:https://github.com/leonidas/transparency
!(function t(e, n, r) {
  function i(s, u) {
    if (!n[s]) {
      if (!e[s]) {
  ...
  for (
    var o = "function" == typeof require && require, s = 0; s < r.length; s++
  )
    i(r[s]);
  return i;
})({
        ...
        (l = (function(t) {
          function e(t, e) {
            ...
            (this.templateValue = function() {
                var t, e, r, i;
                for (
                  r = this.el.childNodes, i = [], t = 0, e = r.length; e > t; t++
                )
                  (n = r[t]),
          ...
          return (
            ...
            (t.prototype.render = s(n)(
              o(e)(
                u(function(t, e, n) {
                  for (
                    var r, o, s, u, a, h, c; t.length < this.instances.length;
        ...
        (o = (function() {
          ...
          return (
            (t.prototype.empty = function() {
              for (var t;
                (t = this.el.firstChild);) this.el.removeChild(t);
              return this;
            }),
        ...
        (e.exports = r = (function() {
          ...
          return (
            (t.prototype.remove = o(function() {
              var t, e, n, r, i;
              for (
                r = this.childNodes, i = [], t = 0, e = r.length; e > t; t++
              )
            ...
            (t.prototype.appendTo = o(function(t) {
              var e, n, r, i, o;
              for (
                i = this.childNodes, o = [], e = 0, n = i.length; n > e; e++
              )
              ...
              return (
                (r =
                  ...
                  (e[t] = function() {
                    var e, r, i, o;
                    for (
                      i = this.elements, o = [], e = 0, r = i.length; r > e; e++
                    )
                      (n = i[e]),
